...
- Duration: 8.8 min
- Distance: 1.36 km
- Environment: port area with aggressive maneuvers, strong loop closure opportunities, and nearby vessel traffic.

**Comments:** This scene is ideal for evaluating SLAM robustness under frequent heading changes and close-range quay structures. The recorded path includes a short loop within the harbor and a return segment near the quay.

![berlin_00 path](figures/berlin_00_path.png)
...
- Duration: 10.3 min
- Distance: 1.42 km
- Environment: port area with bridge passage and moderate loop closures.

**Comments:** The route captures bridge approach and departure, useful for testing perception in mixed open/structured waters and assessing trajectory alignment around overhead obstacles.

![berlin_01 path](figures/berlin_01_path.png)
